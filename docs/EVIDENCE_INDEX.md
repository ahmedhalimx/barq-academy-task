...
| Recorded challenge / final 3-app port 8090 state | `.assessment/challenge.json`, final diff | Not run; must be created during the one permitted recording | Required during video |

- Repository URL: pending user remote/push.
- Final commit: pending runtime and documentation completion.
- Continuous video URL and challenge receipt: pending.
- Do not replace pending items with claims until the command output and recording exist.
